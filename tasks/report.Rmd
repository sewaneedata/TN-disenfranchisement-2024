...
CAVEATS
1. We don't know if incarceration is based on where they are convicted, their street address, or where they're imprisoned
2. We took a state-wide proportion and generalized it to all counties, which is not entirely true to reality. 
